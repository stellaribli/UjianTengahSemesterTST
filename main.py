...
fake_users_db = {
    "asdf": {
        "username": "asdf",
        "full_name": "Stella Ribli",
        "email": "riblistella@gmail.com",
        "hashed_password": "$2b$12$WZG/yZ8a8J9ILQPfYoDKd.bnifDO8ybcvLP/vX06.6xng4SZ1IipS",
        "disabled": False,
    }
}
...
app = FastAPI(description ="API Authentication 18219027")
...
@app.delete('/menu/{item_id}', tags=["Edit Menu"])
